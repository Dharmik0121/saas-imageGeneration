    ...
    return (
        ...
        >
            ...
            {!isImageLoaded && (<>
                {credit === 0 ? (
                    <>
                        <p className="mt-5">Insufficient Credit. Please, buy the credits.</p>
                        <button
                            type="submit"
                            className="bg-zinc-900 cursor-pointer px-10 sm:px-16 py-3 rounded-full text-white "
                    ...
                    <>
                        <div className="flex w-full max-w-xl bg-neutral-600 text-white text-sm p-0.5 mt-10 rounded-full">
                            ...
                            <button
                                type="submit"
                                className="bg-zinc-900 cursor-pointer px-10 sm:px-16 py-3 rounded-full "
                            >
                                Generate
                            </button>
                        </div>
